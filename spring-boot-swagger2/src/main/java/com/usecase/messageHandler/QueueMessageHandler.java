...
class OrderMsgHandler extends BaseMsgHandler {
    ...
    public void processMessage() {
        ...
        try {
            ...
            System.out.println("ORDER processed successully , message" + message);
...
class NotificationMsgHandler extends BaseMsgHandler {
    ...
    public void processMessage() {
        ...
        try {
            ...
            System.out.println("Notification sent for message " + message);
        } catch (InterruptedException e) {
            System.out.println("Error in NotificationMsgHandler");
            e.printStackTrace();
        }
